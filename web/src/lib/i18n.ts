...
const zh: LocalePack = {
  ...
  terminal: {
    ...
    onboarding: {
      ...
      step2Title: "先看结论和风险",
      step2Body: "首屏会先展示本次结论、风险一句话和下一步动作，再展开完整报告。",
      step3Title: "再看回测并导出",
      step3Body: "查看组合历史表现后，可以直接导出报告用于展示或讨论。",
      skip: "跳过引导",
      prev: "上一步",
      next: "下一步",
      done: "完成引导",
...
const en: LocalePack = {
  ...
  terminal: {
    ...
    onboarding: {
      ...
      step2Title: "Read decision and risk first",
      step2Body: "The first screen highlights verdict, risk in one line and the next action before full details.",
      step3Title: "Check backtest and export",
      step3Body: "Review historical performance, then export the report for sharing.",
      skip: "Skip",
      prev: "Previous",
      next: "Next",
      done: "Finish",
